...
export default function App() {
  ...
  const upd = p => { const n={...data,...p}; setData(n); persist(n); };
            ...
            <C style={{gap:16}}>
              ...
              <div className="card" style={{padding:22}}>
                ...
                <R style={{gap:8,marginBottom:10}}>
                  <input className="inp" placeholder="What did you spend on?" value={newTx.label}
        ...
        {menuOpen&&(
          <>
            ...
            <div style={{
              ...
              width:"calc(100% - 40px)",maxWidth:520,zIndex:45,
              ...
              {[
                ...
                >
                  ...
                  <I n="chevron" s={16} c="#ccc9c0" style={{marginLeft:"auto",flexShrink:0}}/>
                </button>
              ))}
            </div>
          </>
